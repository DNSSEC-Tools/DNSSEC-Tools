...
Patch8: dnssec-tools-fix-tcp-read-1.12.patch
...
mv %{buildroot}/usr/bin/validate  %{buildroot}/usr/bin/dt-validate
mv %{buildroot}/%{_mandir}/man1/validate.1 %{buildroot}/%{_mandir}/man1/dt-validate.1
