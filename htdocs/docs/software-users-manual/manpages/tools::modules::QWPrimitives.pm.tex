...
\perlmod{Net::DNS::SEC::Tools::QWPrimitives} - \perlmod{QWizard} primitives for
DNSSEC-Tools
...
\var{\_\_otherargs} \var{qwparam} variable, which is used by
\perlmod{Getopt::GUI::Long} to generate the \var{\@ARGV} list.
