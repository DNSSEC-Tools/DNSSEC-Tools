...
our $VERSION = '1.31';   # current release version number
...
our @EXPORT = qw(
 ...
 VAL_QFLAGS_USERMASK VAL_QUERY_DONT_VALIDATE VAL_QUERY_GLUE_REQUEST
 VAL_QUERY_NO_AC_DETAIL VAL_QUERY_NO_DLV VAL_QUERY_USING_DLV
 VAL_Q_ONLY_MATCHING_FLAGS VAL_RESOURCE_UNAVAILABLE VAL_SUCCESS
