...
our @EXPORT = qw(ALG_DH ALG_DSASHA1 ALG_DS_HASH_SHA1 ALG_NSEC3_DSASHA1
	       ...
	       CAN_SIGN_ZONE_AND_KEY DNS_PORT EDNS_UDP_SIZE
	       NS_CMPRSFLGS
	       NS_INT16SZ NS_INT32SZ NS_MAXCDNAME NS_MAXDNAME
	       ...
	       ZONE_USE_TSIG VAL_TRUSTED_ANSWER VAL_VALIDATED_ANSWER 
	       VAL_UNTRUSTED_ANSWER VAL_BAD_PROVABLY_UNSECURE 
	       VAL_AC_RRSIG_VERIFIED_SKEW VAL_AC_WCARD_VERIFIED_SKEW
	      );
