...
#
#     Copyright (c) 2006-2011 SPARTA, Inc.  All rights reserved.
#
...
our $VERSION = '1.50';   # current release version number
...
our @EXPORT = qw(
 ALG_DH ALG_DSASHA1 ALG_DS_HASH_SHA1 ALG_DS_HASH_SHA256
 ALG_NSEC3_DSASHA1 ALG_NSEC3_HASH_SHA1 ALG_NSEC3_RSASHA1 ALG_RSAMD5
 ALG_RSASHA1 CANNOT_BE_USED CAN_SIGN_KEY CAN_SIGN_ZONE
 CAN_SIGN_ZONE_AND_KEY DNAME_MAX DNS_PORT EDNS_UDP_SIZE ENVELOPE
 MAX_ALIAS_CHAIN_LENGTH MAX_GLUE_FETCH_DEPTH MAX_PROOFS
 NSEC3_FLAG_OPTOUT QUERY_BAD_CACHE_THRESHOLD QUERY_BAD_CACHE_TTL
 Q_ANSWERED Q_CONFLICTING_ANSWERS Q_ERROR_BASE Q_INIT 
 Q_MISSING_GLUE Q_QUERY_ERROR Q_REFERRAL_ERROR Q_RESPONSE_ERROR Q_SENT
 Q_WAIT_FOR_GLUE Q_WRONG_ANSWER RRSIGLABEL 
 SHA256_DIGEST_LENGTH SHA512_DIGEST_LENGTH
 SHA_DIGEST_LENGTH SIGNBY SR_ANS_BARE_RRSIG SR_ANS_CNAME SR_ANS_DNAME
 SR_ANS_NACK SR_ANS_STRAIGHT SR_ANS_UNSET SR_CALL_ERROR
 ...
 SR_CRED_UNSET SR_DNS_GENERIC_ERROR SR_EDNS_VERSION_ERROR SR_FORMERR
 ...
 SR_ZI_STATUS_LEARNED SR_ZI_STATUS_PERMANENT SR_ZI_STATUS_UNSET TTL
 VALIDATOR_LOG_PORT VAL_AC_ALGORITHM_NOT_SUPPORTED VAL_AC_BAD_BASE
 VAL_AC_BARE_RRSIG VAL_AC_CAN_VERIFY VAL_AC_DATA_MISSING
 VAL_AC_DNSKEY_MISSING VAL_AC_DNSKEY_NOMATCH VAL_AC_DNS_ERROR
 VAL_AC_DONT_GO_FURTHER VAL_AC_DS_MISSING VAL_AC_DS_NOMATCH
 VAL_AC_ERROR_BASE VAL_AC_FAIL_BASE VAL_AC_IGNORE_VALIDATION
 VAL_AC_INIT VAL_AC_INVALID_DS VAL_AC_INVALID_KEY VAL_AC_INVALID_RRSIG 
 VAL_AC_LAST_BAD VAL_AC_LAST_ERROR VAL_AC_LAST_FAILURE VAL_AC_LAST_STATE
 VAL_AC_NEGATIVE_PROOF VAL_AC_NOT_VERIFIED VAL_AC_NO_LINK
 VAL_AC_PINSECURE VAL_AC_RRSIG_ALGORITHM_MISMATCH
 VAL_AC_RRSIG_EXPIRED VAL_AC_RRSIG_MISSING VAL_AC_RRSIG_NOTYETACTIVE
 VAL_AC_RRSIG_VERIFIED VAL_AC_RRSIG_VERIFIED_SKEW
 VAL_AC_RRSIG_VERIFY_FAILED VAL_AC_SIGNING_KEY VAL_AC_TRUST
 ...
 VAL_AC_WRONG_LABEL_COUNT VAL_BAD_ARGUMENT VAL_PINSECURE_UNTRUSTED
 VAL_BARE_RRSIG VAL_BARE_TRUST_KEY VAL_BOGUS VAL_BOGUS_PROOF
 VAL_BOGUS_PROVABLE VAL_CONF_NOT_FOUND VAL_CONF_PARSE_ERROR
 VAL_CTX_IDLEN VAL_DNS_ERROR VAL_DONT_KNOW VAL_EACCESS VAL_EINVAL
 VAL_ENOENT VAL_ENOMEM VAL_ENOSYS VAL_FLAG_CHAIN_COMPLETE
 VAL_FROM_ADDITIONAL VAL_FROM_ANSWER VAL_FROM_AUTHORITY VAL_FROM_QUERY
 VAL_FROM_UNSET VAL_IGNORE_VALIDATION VAL_INCOMPLETE_PROOF
 VAL_INTERNAL_ERROR VAL_IRRELEVANT_PROOF VAL_OOB_ANSWER
 ...
 VAL_OUT_OF_MEMORY VAL_POL_GOPT_DISABLE VAL_POL_GOPT_ENABLE
 VAL_POL_GOPT_OVERRIDE VAL_PINSECURE VAL_QFLAGS_ANY
 VAL_QFLAGS_USERMASK VAL_QFLAGS_CACHE_MASK
 VAL_QUERY_NO_AC_DETAIL VAL_QUERY_NO_EDNS0 VAL_QUERY_DONT_VALIDATE 
 VAL_QUERY_GLUE_REQUEST VAL_QUERY_USING_DLV VAL_QUERY_NO_DLV 
 VAL_RESOURCE_UNAVAILABLE VAL_SUCCESS VAL_QUERY_REFRESH_QCACHE
 VAL_TRUSTED_ANSWER VAL_UNTRUSTED_ANSWER
 VAL_UNTRUSTED_ZONE VAL_VALIDATED_ANSWER 
 ZONE_USE_NOTHING ZONE_USE_TSIG ns_t_dlv ns_t_dnskey ns_t_ds ns_t_nsec
 ns_t_nsec3 ns_t_rrsig
	      );
