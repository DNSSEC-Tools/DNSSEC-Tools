...
I<val_x_getaddrinfo()> performs the same function as I<val_getaddrinfo()>,
but is optimized for multiple calls.  The two routines take the same
parameters, but I<val_x_getaddrinfo()> takes an additional parameter I<ctx>,
...
I<get_context(3)> for information on creating a validation context.)
I<val_getaddrinfo()> is equivalent to calling I<val_x_getaddrinfo()> with a
...
I<get_context(3)>, I<val_duphostent(3)>, I<val_freehostent(3)>,
I<val_gethostbyname(3)>, I<val_query(3)>, I<val_x_gethostbyname(3)>,
I<val_x_query(3)>
