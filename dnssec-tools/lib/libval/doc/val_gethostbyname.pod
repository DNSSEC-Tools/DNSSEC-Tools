...
I<get_context()> for information on creating a validation context.)
I<val_gethostbyname()> is equivalent to calling I<val_x_gethostbyname()>
...
I<get_context(3)>, I<val_dupaddrinfo(3)>, I<val_freeaddrinfo(3)>,
I<val_getaddrinfo(3)>, I<val_query(3)>, I<val_x_getaddrinfo(3)>,
I<val_x_query(3)>
