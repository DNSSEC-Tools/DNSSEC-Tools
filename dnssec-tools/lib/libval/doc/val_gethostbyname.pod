...
=head1 SYNOPSIS
  ...
  struct hostent *val_x_gethostbyname(val_context_t *ctx,
...
default validation context is used.  I<val_gethostbyname()> is equivalent to
calling I<val_x_gethostbyname()> with a B<NULL> I<ctx> parameter.
...
I<p_val_error>, I<val_getaddrinfo>, I<val_x_getaddrinfo>,
