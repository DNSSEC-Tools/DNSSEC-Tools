...
I<response> must be large enough to hold the number of bytes returned in 
I<response_length>. The memory pointed to by I<*respondent> is allocated 
...
The currently defined members of I<struct name_server> are:
