...
#undef GETHOSTBYADDR_USES_VOID_SOCKLEN
...
#undef GETNAMEINFO_USES_SOCKLEN_AND_INT
...
#undef VALIDATOR_TESTCASES

/* dnsval configuration file */
#undef VAL_CONFIGURATION_FILE
...
#undef VAL_RESOLV_CONF

/* Path to root hints config file */
#undef VAL_ROOT_HINTS
