...
{
    QMessageBox message;
    message.setText("<p><b>DNSSEC-Check</b><p><i>DNSSEC-Tools Version: 1.13</i></p><p>DNSSEC-Check tests the likelyhood that your network will support client-side DNSSEC validation.  "
