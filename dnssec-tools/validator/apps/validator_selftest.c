...
vtc_parse_result(const char *result)
{
    ...
    result_map rm[] = {
        ...
        {"BOGUS_PROVABLE", VAL_BOGUS_PROVABLE},
        {"VERIFIED_CHAIN", VAL_VERIFIED_CHAIN},
        {"NOTRUST", VAL_NOTRUST},
        {"SUCCESS", VAL_SUCCESS},
        {"DNS_QUERY_ERROR", VAL_DNS_QUERY_ERROR},
        {"DNS_RESPONSE_ERROR", VAL_DNS_RESPONSE_ERROR},
        {"DNS_WRONG_ANSWER", VAL_DNS_WRONG_ANSWER},
        {"DNS_REFERRAL_ERROR", VAL_DNS_REFERRAL_ERROR},
        {"DNS_MISSING_GLUE", VAL_DNS_MISSING_GLUE},
        {"DNS_CONFLICTING_ANSWERS", VAL_DNS_CONFLICTING_ANSWERS},
        {"PROVABLY_UNSECURE", VAL_PROVABLY_UNSECURE},
        ...
        {"BAD_PROVABLY_UNSECURE", VAL_BAD_PROVABLY_UNSECURE},
        {NULL, 0}
    };
