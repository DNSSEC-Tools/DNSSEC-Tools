...
static const struct testcase_st testcases[] = {
    ...
    {"Test Case 8", "good-cname-to-badsign-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_SUCCESS, VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 9", "good-cname-to-nosig-A.test.dnssec-tools.org", ns_c_in,
     ns_t_a, {VAL_SUCCESS, VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 13", "badsign-cname-to-good-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_PROVABLE, VAL_SUCCESS, 0}},
    {"Test Case 14", "badsign-cname-to-badsign-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_PROVABLE, VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 15", "badsign-cname-to-nosig-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_PROVABLE, VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 19", "nosig-cname-to-good-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_INDETERMINATE, VAL_SUCCESS, 0}},
    {"Test Case 20", "nosig-cname-to-badsign-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_INDETERMINATE, VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 21", "nosig-cname-to-nosig-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_INDETERMINATE, VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 35",
     ...
     ns_t_a, {VAL_BOGUS_PROVABLE, VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 36",
    ...
    {"Test Case 44", "badsign-AAAA.test.dnssec-tools.org", ns_c_in,
     ns_t_aaaa, {VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 45", "nosig-AAAA.test.dnssec-tools.org", ns_c_in,
     ns_t_aaaa, {VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 50", "good-cname-to-badsign-AAAA.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_SUCCESS, VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 51", "good-cname-to-nosig-AAAA.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_SUCCESS, VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 55", "badsign-cname-to-good-AAAA.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS_PROVABLE, VAL_SUCCESS, 0}},
    {"Test Case 56", "badsign-cname-to-badsign-AAAA.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS_PROVABLE, VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 57", "badsign-cname-to-nosig-AAAA.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS_PROVABLE, VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 65",
     ...
     ns_t_aaaa, {VAL_INDETERMINATE, VAL_BOGUS_PROVABLE, 0}},
    ...
    {"Test Case 71",
     ...
     ns_t_aaaa, {VAL_BOGUS_PROVABLE, VAL_SUCCESS, 0}},
    {"Test Case 72",
    ...
    {"Test Case 75",
     ...
     ns_t_aaaa, {VAL_BOGUS_PROVABLE, VAL_INDETERMINATE, 0}},
    {"Test Case 76",
    ...
    {"Test Case 95", "futuredate-AAAA.good-ns.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS_PROVABLE, 0}},
    ...
    {"Test Case 100", "badsign-A.badsign-ns.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_UNPROVABLE, 0}},
    ...
    {"Test Case 106", "badsign-AAAA.badsign-ns.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS_UNPROVABLE, 0}},
    {"Test Case 107", "nosig-AAAA.badsign-ns.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 111", "addedlater-A.badsign-ns.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_PROOF, 0}},
    {"Test Case 112", "addedlater-AAAA.badsign-ns.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS_PROOF, 0}},
    ...
    {"Test Case 117", "futuredate-A.nosig-ns.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_INDETERMINATE, 0}},
    ...
    {"Test Case 141", "good-A.futuredate-ds.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_PROVABLE, 0}},
    {"Test Case 142", "badsign-A.futuredate-ds.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS, 0}},
    ...
    {"Test Case 150", "baddata-AAAA.futuredate-ds.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS, 0}},
    {"Test Case 151",
     "futuredate-AAAA.futuredate-ds.test.dnssec-tools.org", ns_c_in,
     ns_t_aaaa, {VAL_BOGUS, 0}},
    ...
    {"Test Case 153", "addedlater-A.futuredate-ds.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_PROOF, 0}},
    {"Test Case 154",
     "addedlater-AAAA.futuredate-ds.test.dnssec-tools.org", ns_c_in,
     ns_t_aaaa, {VAL_BOGUS_PROOF, 0}},
