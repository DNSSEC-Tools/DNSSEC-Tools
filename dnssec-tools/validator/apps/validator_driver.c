...
static const struct testcase_st testcases[] = {
    ...
    {"Test Case 15", "badsign-cname-to-nosig-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_BOGUS_PROVABLE, VAL_ERROR, 0}},
    ...
    {"Test Case 20", "nosig-cname-to-badsign-A.test.dnssec-tools.org",
     ns_c_in, ns_t_a, {VAL_ERROR, VAL_BOGUS_PROVABLE, 0}},
    ...
    {"Test Case 57", "badsign-cname-to-nosig-AAAA.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_BOGUS_PROVABLE, VAL_ERROR, 0}},
    ...
    {"Test Case 62", "nosig-cname-to-badsign-AAAA.test.dnssec-tools.org",
     ns_c_in, ns_t_aaaa, {VAL_ERROR, VAL_BOGUS_PROVABLE, 0}},
    ...
    {"Test Case 65",
     ...
     ns_t_aaaa, {VAL_ERROR, VAL_BOGUS_PROVABLE, 0}},
    ...
    {"Test Case 75",
     ...
     ns_t_aaaa, {VAL_BOGUS_PROVABLE, VAL_ERROR, 0}},
    {"Test Case 76",
