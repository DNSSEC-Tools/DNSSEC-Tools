...
host entry value of type I<struct hostent> and are DNSSEC-aware versions of
...
I<val_gethostbyaddr_r()> support only IPv4 addresses.  IPv4 and IPv6 addresses
are supported by I<val_gethostbyname2()> and I<val_gethostbyname2_r()>.
