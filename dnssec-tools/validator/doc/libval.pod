...
The verification status of the RRSIG. In addition to any of the
assertion status values pertaining to signature verification, this
field can also have the value VAL_AC_VERIFIED_LINK for some DNSKEY 
