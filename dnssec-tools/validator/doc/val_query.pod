...
The validation status is returned in the I<vr_val_status> field of the
I<val_response> structure for that RRSet.  I<p_val_status()> returns a brief
...
The I<val_query()> function returns 0 on success.  It invokes
I<resolve_n_check()> internally and errors from this function may be returned.
