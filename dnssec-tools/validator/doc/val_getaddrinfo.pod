...
I<getaddrinfo(3)>).  I<val_addrinfo> has an additional field I<ai_val_status>
that represents the validation status for that particular record.
...
useful manner.  (See I<libval(3)> for more information).
