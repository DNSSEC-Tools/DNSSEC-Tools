...
I<val_getaddrinfo()>, I<val_freeaddrinfo()> - get DNSSEC-validated network
...
val_addrinfo> in the I<res> parameter.  I<val_getnameinfo> is used to convert a
...
struct I<val_addrinfo> instead of I<struct addrinfo>.  Please see the manual
