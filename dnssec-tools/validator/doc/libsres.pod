...
I<query_send()>, I<response_rcv()>, get()> - 
send queries and receive responses from a DNS name server.

I<clone_ns()>, I<clone_ns_list()>, I<free_name_server()>, I<free_name_servers()> -
Manage name servers
...
Specifies additional resolver flags. Currently defined flags are RES_RECURSE,
which sets the "Recursion Desired" flag; RES_USE_DNSSEC, which sets the
"DNSSEC OK" bit in the EDNS0 header; and RES_DEBUG, which enables debugging.
